    ...
    <>
      ...
      <div class="min-h-screen" style={{ background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%)' }}>
        ...
        <main class="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
            ...
            <div class="space-y-6">
              ...
              <div class="relative clip-corner-both bg-zinc-900/40 border border-zinc-800/30 overflow-hidden group hover:border-amber-500/20 transition-all">
                <div class="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-0">
                  <div class="flex items-center justify-center p-8 bg-zinc-900/60 border-b md:border-b-0 md:border-r border-zinc-800/30">
                  ...
                  <div class="p-8 md:p-10">
                    <h3 class="text-xl font-bold text-white mb-3">Met in college, built for fun</h3>
                    <p class="text-zinc-400 leading-relaxed">
              ...
              <div class="relative clip-corner-both bg-zinc-900/40 border border-zinc-800/30 overflow-hidden group hover:border-amber-500/20 transition-all">
                <div class="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-0">
                  ...
                  <div class="p-8 md:p-10">
                    <h3 class="text-xl font-bold text-white mb-3">Testing the market in Naga City</h3>
                    <p class="text-zinc-400 leading-relaxed">
              ...
              <div class="relative clip-corner-both bg-zinc-900/40 border border-zinc-800/30 overflow-hidden group hover:border-amber-500/20 transition-all">
                <div class="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-0">
                  ...
                  <div class="p-8 md:p-10">
                    <h3 class="text-xl font-bold text-white mb-3">KahitSan Corporation</h3>
                    <p class="text-zinc-400 leading-relaxed">
          ...
          <section class="mb-32">
            <div class="clip-corner-both bg-zinc-900/30 p-12 md:p-16 relative border border-zinc-800/30 overflow-hidden">
            ...
            <div class="relative clip-corner-both bg-zinc-900/40 border border-zinc-800/30 overflow-hidden group hover:border-amber-500/20 transition-all">
              <div class="p-10 md:p-12">
                <div class="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 class="text-xl font-bold text-white mb-3">Expanding our reach</h3>
                    <p class="text-zinc-400 leading-relaxed">
