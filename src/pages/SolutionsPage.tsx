        ...
        <section class="mb-32">
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <div class="md:col-span-3 bg-amber-500/10 p-[1px] clip-corner-both">
              <div class="bg-zinc-900 h-full p-10 clip-corner-both flex flex-col md:flex-row gap-10">
                <div class="flex-1 flex flex-col">
                  ...
                  <Show when={allAccess.coverImage}>
                    <img
                      ...
                      alt={allAccess.name}
                      class="w-full h-40 object-cover clip-corner mt-auto"
                    />
                  </Show>
                </div>
            ...
            <div class="md:col-span-2 bg-zinc-900 clip-corner-both p-10 flex flex-col">
              ...
              <Show when={wholeInner.coverImage}>
                <img
                  ...
                  alt={wholeInner.name}
                  class="w-full h-40 object-cover clip-corner mb-8"
                />
              </Show>
