...
import { X as X$1, V as V$1 } from './logo-Cs-eLjvO.mjs';
import { Z as Ze, e as et, n as nt, E as E$1 } from '../nitro/nitro.mjs';

function f(e) {
  e = mergeProps({ inactiveClass: "inactive", activeClass: "active" }, e);
  const [, t] = splitProps(e, ["href", "state", "class", "activeClass", "inactiveClass", "end"]), s = Ze(() => e.href), a = et(s), v = nt(), m = createMemo(() => {
    const p = s();
...
const y = [{ icon: R, label: "Home", href: "/" }, { icon: O, label: "Spaces", href: "/spaces" }, { icon: D, label: "Community", href: "/community" }, { icon: V, label: "Announcements", href: "/announcements" }, { icon: Q, label: "Account", href: "/account" }], pe = () => {
  ...
  return [ssr(oe, ssrHydrationKey(), escape(createComponent(f, { href: "/", class: "flex items-center gap-3 hover:opacity-80 transition-opacity", get children() {
  ...
  } }))), e() ? escape(createComponent(se, { size: 24 })) : escape(createComponent(te, { size: 24 }))), e() && ssr(ce, ssrHydrationKey()), ssr(ie, ssrHydrationKey(), `fixed top-16 right-0 bottom-0 w-64 z-40 bg-zinc-900/95 backdrop-blur-xl border-l border-zinc-800/50 transform transition-transform duration-300 md:hidden ${e() ? "translate-x-0" : "translate-x-full"}`, escape(y.map((a) => createComponent(V$1, { as: f, get href() {
    return a.href;
  }, get end() {
    return a.href === "/";
  }, variant: "clip1", intent: "secondary", get icon() {
...
//# sourceMappingURL=Footer-CPIJvVmb.mjs.map
